...
if __name__ == '__main__':
    ...
    # test_sentence_1 = '北京市百融金服科技有限公司'  # cos：0.9999839620230886  0.043129391793413574  enclidean：0.027304886398964206  V2:0.030312174677792212
    ...
    # test_sentence_1 = '黑龙江兴隆农垦民乐农业生产资料有限公司'

    # 第三组测试
    # test_sentence_2 = '四川省蚌埠悠然酒店管理有限公司'
    # test_sentence_1 = '蚌埠悠然酒店管理有限公司'  
    # test_sentence_1 = '安徽省蚌埠华康悠然酒店管理公司'
